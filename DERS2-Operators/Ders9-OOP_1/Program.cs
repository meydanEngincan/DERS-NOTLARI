...
namespace Ders9_OOP_1
{
    ...
    ///// derslik isimli sınıfı aşağıdaki özellik ve metotlar ile tanımlayınız. Bu senaryo:1 öğretmenin 1 sınıfı var.1 öğretmen 1 derslikte ders işler Dersliğin öğretmeni olsun. 
    ///derslik propları= derslikNo,adi,kapasite,kat,ogretmen.
    ///derslikAtamaKontrol(Ogretmen) => bool : öğretmenin öğrenci sayısı sınıf kapasitesine sığıyorsa true yoksa false
